...
export default async function HospitalDetail({params} : {params:{hid:string}}){
    ...
    return(
        <main className="text-center p-5">
            ...
            <div className=" text-3xl font-semibold p-4 text-emerald-600 drop-shadow-sm ">{hospitalDetail.data.name}</div>
            <div className="flex flex-row my-5 block ml-50 mr-auto">
                ...
                <div className="text-md text-left mx-7 text-slate-600">
